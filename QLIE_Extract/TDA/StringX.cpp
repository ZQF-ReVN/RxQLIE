...
namespace TDA
{
	...
	void StringX::StrToWStr(std::string& strString, std::wstring& wsString, unsigned int uCodePage)
	{
	...
	void StringX::WStrToStr(std::wstring& wsString, std::string& strString, unsigned int uCodePage)
	{
	...
	void StringX::StrToWStr_CVT(std::string& strString, std::wstring& wsString, unsigned int uCodePage)
	{
	...
	void StringX::WStrToStr_CVT(std::wstring& wsString, std::string& strString, unsigned int uCodePage)
	{
		std::wstring_convert<std::codecvt_byname<wchar_t, char, mbstate_t>> cvtString
		(
			new std::codecvt_byname<wchar_t, char, mbstate_t>('.' + std::to_string(uCodePage))
